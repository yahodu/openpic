...
import { ImageProps, SharedModalProps } from "@/app/utils/types";
import {
  ArrowDownTrayIcon,
...
export default function SharedModal({
  ...
  // Calculate aspect ratio for the current image
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          aspectRatio: imageAspectRatio > 3 / 2 ? `${imageAspectRatio}` : "3/2",
        }}
        {...handlers}
      >
        {/* Main image */}
